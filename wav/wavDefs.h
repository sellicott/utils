...
//#define ABSOLUTE 1
	...
	#define		BLOCK_ALLIGN	32	//NumChannels * BitsPerSample/8 (unsigned char)
	...
	#define		BLOCK_ALLIGN	20	//NumChannels * BitsPerSample/8 (unsigned char)
							//1 - 8 bit mono, 2 - 8 bit stereo/16 bit mono, 4 - 16 bit stereo
...
typedef struct WaveFmtChunk{
	...
	uint16_t block_allign;		//1 - 8 bit mono
